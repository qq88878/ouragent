 ...
 *   - Implement SecurityFilterChain with:
 *     1. Disable CSRF
 *     2. Stateless session management
 *     3. Permit /api/auth/**, /api/agent/health, /health
...
public class SecurityConfig {
    ...
    // TODO: Inject JwtAuthenticationFilter once implemented
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        ...
        //       .requestMatchers("/api/auth/**", "/api/agent/health", "/health").permitAll()

...
public class Course extends BaseEntity {
    ...
    public java.lang.String toString() {
        return "Course(title=" + this.getTitle() + ", description=" + this.getDescription() + ", coverImage=" + this.getCoverImage() + ", teacherId=" + this.getTeacherId() + ", category=" + this.getCategory() + ", difficulty=" + this.getDifficulty() + ", status=" + this.getStatus() + ")";
    }
